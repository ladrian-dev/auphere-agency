...
export function AnimatedMark({
  ...
  useAuphereGSAP(
    ({ reduced, gsap }) => {
      ...
      if (!trail || !comet || !maskCircle || !outline) return undefined;
      ...
      // Entrada por IntersectionObserver, no por ScrollTrigger: un trigger que
      // no refresca dejaba la marca sin dibujar para siempre (§F-2).
      ...
      return onEnter(svgRef.current, () => tl.play());
    },
    {
      scope: svgRef,
